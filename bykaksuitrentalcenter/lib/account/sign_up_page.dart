                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      child: Text(
                        '순양 렌탈센터',
                        style: TextStyle(fontSize: 40, color: style.blackColor, fontWeight: style.boldText),
                      ),
                    ),
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: Text('회원정보', style: TextStyle(fontSize: 24, fontWeight: style.boldText)),
                          ),
                          ...
                          ConstrainedBox(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: '이름',
                                labelText: '이름',
                                floatingLabelStyle: TextStyle(color: style.mainColor),
                                border: OutlineInputBorder(borderSide: BorderSide(width: 1), borderRadius: BorderRadius.circular(8)),
                                focusedBorder: OutlineInputBorder(borderSide: BorderSide(width: 2, color: style.mainColor), borderRadius: BorderRadius.circular(8)),
                              ),
                            ),
                          ),
                          Padding(padding: EdgeInsets.all(8)),
                    ...
                    ConstrainedBox(
                      ...
                      child: Column(
                        children: [
                          Container(
                            width: double.infinity,
                            child: Text('계정정보', style: TextStyle(fontSize: 24, fontWeight: style.boldText)),
                          ),
                          Padding(padding: EdgeInsets.all(8)),
                          ConstrainedBox(
                            constraints: BoxConstraints(
                      ...
                      child: InkWell(
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              '가입하기',
                              style: TextStyle(fontSize: 24, color: style.whiteColor),
                            ),
                          ),
                        ),
                        onTap: () {},
