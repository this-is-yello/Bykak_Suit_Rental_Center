      ...
      builder: (context, orientation, screenType) {
        return Container(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('대여샵', style: TextStyle(fontSize: style.h3FontSize(context), color: style.greyColor)),
              Padding(padding: EdgeInsets.only(top: style.paddingSize(context))),
              Text('상품명', style: TextStyle(fontSize: style.h3FontSize(context), color: style.blackColor)),
              Padding(padding: EdgeInsets.only(top: style.paddingSize(context))),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('50000원', style: TextStyle(fontSize: style.h3FontSize(context) + 4, color: style.blackColor, fontWeight: style.boldText)),
                  Container(
                    child: Row(
                      children: [
                        IconButton(
              ...
              Padding(padding: EdgeInsets.only(top: style.paddingSize(context))),
              InkWell(
                child: Text('(0 개의 후기)', style: TextStyle(fontSize: style.h4FontSize(context), color: style.greyColor)),
                onTap: () {},
              ),
              Padding(padding: EdgeInsets.only(top: style.paddingSize(context))),
              InkWell(
                child: Container(
                  ...
                  child: Center(child: Text('예약하기', style: TextStyle(fontSize: style.h3FontSize(context), color: style.whiteColor))),
                ),
                onTap: () {
              ...
              InkWell(
                child: Container(
                  ...
                  child: Center(child: Text('장바구니', style: TextStyle(fontSize: style.h3FontSize(context), color: style.mainColor))),
                ),
                onTap: () {},
              ),
            ],
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          IconButton(
            icon: Icon(Icons.keyboard_double_arrow_down_rounded, size: 30,  color: style.blackColor),
            onPressed: () {
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Text('상의 사이즈: ', style: TextStyle(fontSize: 18, color: style.blackColor, fontWeight: style.boldText)),
          ...
          Container(
            ...
            child: Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Text('하의 사이즈: ', style: TextStyle(fontSize: 18, color: style.blackColor, fontWeight: style.boldText)),
                Padding(padding: EdgeInsets.all(8)),
                DropdownButton(
                  style: TextStyle(fontSize: 18),
          ...
          Column(
            ...
            children: [
              Container(
                child: Text('※평소에 입으시는 옷의 사이즈를 선택해주세요.', style: TextStyle(fontSize: 12)),
              ),
              Container(
                child: Text('※고르신 사이즈와 매장에서 대여하실 옷의 사이즈는 다를 수 있습니다.', style: TextStyle(fontSize: 12)),
              ),
            ],
          ),
          Padding(padding: EdgeInsets.all(8)),
